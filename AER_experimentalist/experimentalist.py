...
class Experimentalist(ABC):
    ...
    def generate_seed_experiment_default(self, object_of_study):
        print('in generate_seed_experiment_default...') 
        ...
        # print('exp design length:', len(experiment_design)) 
        block = fully_cross_block(experiment_design, experiment_design, [])
        # print('im a fully crossed block: ', block.complex_factors_or_constraints)
        experiment_sequence = synthesize_trials_non_uniform(block, 1)[0]

        print('num_trials:', len(experiment_sequence[list(experiment_sequence.keys())[0]])) 
        # print('EXPERIMENT SEQ') 
        # num_trials = len(experiment_sequence[list(experiment_sequence.keys())[0]])
        # for i in range(num_trials):
        #     for key in experiment_sequence:
        #         print('key:', key, 'and value:', experiment_sequence[key][i]) 
    ...
    def generate_seed_experiment(self, object_of_study):
        ...
        if self._experiment_design is None:
            print('in generate_seed_experiment branch with no self._experiment_design...')
        ...
        print('calling _write_experiment...')
    ...
    def _write_experiment_file(self, object_of_study, experiment_id = None):
        ...
        print('experiment_file_path: ' + experiment_file_path) 
    ...
    def commission_experiment(self, object_of_study, experiment_file_path):
        ...
        print('commission_experiment experiment_file_name:', experiment_file_name)
    ...
    def sample_experiment(self, model, object_of_study):
        ...
        for condition in range(self.conditions_per_experiment): # should be 
