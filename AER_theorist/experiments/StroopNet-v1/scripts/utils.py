...
try:
    ...
    from cnnsimple.StroopNet_dataset import StroopNetDataset
    from cnnsimple.object_of_study import outputTypes

    import cnnsimple.SimpleNet_dataset as SimpleNetDatasetFile
    import cnnsimple.StroopNet_dataset as StroopNetDatasetFile
except:
    from SimpleNet_dataset import SimpleNetDataset
    from StroopNet_dataset import StroopNetDataset
    from object_of_study import outputTypes

    import SimpleNet_dataset as SimpleNetDatasetFile
    import StroopNet_dataset as StroopNetDatasetFile
...
def get_object_of_study_file(studyObject):
    ...
    dataSets = {
        ...
        'StroopNet': SimpleNetDatasetFile
    }
