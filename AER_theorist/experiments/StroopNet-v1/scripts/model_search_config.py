...
object_of_study = 'StroopNet'   # name of the data-generating object of study
...
max_k = 4                       # maximum number of computations (nodes) in model
min_k = 4                       # minimum number of computations (nodes) in model
max_seed = 5                    # maximum number of seeds tested
num_data_points = 100          # total number of queried data points from object of study

# training
epochs = 100                     # num of training epochs (30)
arch_updates_per_epoch = 20      # num of architecture updates per epoch (20)
param_updates_per_epoch = 20    # num of weight updates per epoch (20)
batch_size = 64                 # batch size (64)
learning_rate = 0.025           # init learning rate
learning_rate_min = 0.001       # min learning rate
...
show_arch_weights = False                                      # flag whether to show weight updates in debug mode
...
arch_weight_decay_list = np.linspace(0, 6e-4, 6)               # list of architecture weight decays searched over (this decay scales with number of degrees of freedom)
