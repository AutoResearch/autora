...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    if args.debug:
      ...
      viz.plot(genotype.normal, graph_filepath, fileFormat='png', input_labels=args.input_labels)
  ...
  if(args.debug):
    viz.plot(genotype.normal, graph_filepath, input_labels=args.input_labels)
...
def evaluate_architectures(train_data, train_queue, valid_queue, bic_valid_queue, model, criterion):
  ...
  for sample_id in range(args.n_models_sampled):
      ...
      viz.plot(genotype.normal, model_graph_filepath, viewFile=False, input_labels=args.input_labels)
