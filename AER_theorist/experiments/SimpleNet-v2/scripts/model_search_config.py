...
# experiment
log_version = 2                 # simulation version (useful for keeping track of results from different runs)
...
n_models_sampled = 10            # num of (distinct) model architectures sampled from final architecture weights
...
# training
epochs = 30                     # num of training epochs (30)
...
arch_weight_decay_list = np.linspace(5e-4, 6e-4, 6)               # list of architecture weight decays searched over (this decay scales with number of degrees of freedom)
