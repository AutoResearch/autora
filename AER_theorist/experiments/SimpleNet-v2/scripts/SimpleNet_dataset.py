...
class SimpleNetDataset(objectOfStudy, Dataset):
    ...
    def __init__(self, num_patterns = 100, sampling = False):
        ...
        self.finalResponse = self.generateLabels(self.stimulus1, self.stimulus2)
    ...
    def sample_model_fit(self, num_patterns, estimator):
        ...
        response = self.generateLabels(stimulus1, stimulus2)
    ...
    def sample_model_fit_2d(self, num_patterns, estimator):
        ...
        for col in range(num_patterns):
            ...
            # generate true labels
            response = self.generateLabels(stim1, stim2)
    ...
    def generateLabels(self, stimulus1, stimulus2):
        ...
        if self._sampling:
            ...
            finalResponse = torch.zeros(num_patterns, 1)
