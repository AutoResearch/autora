...
# experiment
log_version = (
    1  # simulation version (useful for keeping track of results from different runs)
)
...
n_models_sampled = (
    1  # num of (distinct) model architectures sampled from final architecture weights
)
sample_amp = (
    100  # amplifies architecture weight differences before passing through softmax
)
