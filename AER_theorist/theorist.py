...
class Theorist(ABC):
    ...
    def search_model(self, object_of_study, cycle_num):
        # initialize model search
        self.init_meta_search(object_of_study)
        ...
        return self.get_best_model(object_of_study, cycle_num, plot_model=True)
    ...
    @abstractmethod
    def get_best_model(self, object_of_study, cycle_num):
        pass
