...
from priors import arch_priors, coeff_priors, guide_arch_init, guide_coeff_init
...
graph = numpyro.render_model(
    arch_model, model_args=(x, y, coeff_params, arch_priors), filename="arch_model.pdf"
)
graph = numpyro.render_model(
    coeff_model,
    model_args=(x, y, arch_params, True, coeff_priors),
    filename="coeff_model.pdf",
)
