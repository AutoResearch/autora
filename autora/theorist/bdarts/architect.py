...
class Architect(object):
    ...
    def __init__(
        ...
        guide = numpyro.infer.autoguide.AutoNormal(arch_model,
                                                        init_loc_fn=loc_fn)
        self.guide = guide
        ...
        self.svi = numpyro.infer.SVI(arch_model,
                                     self.guide,
                                     self.optimizer,
...
def arch_model(x, y, PRIMITIVES, coeff_params, priors = None): # a_exp, a_tanh, b_exp, b_tanh
