...
def read_target_values(source, quadratic=False):
    ...
    # Number of formulas
    infn1 = "./data_closed_loop/%s.wiki.parsed__num_operations.dat" % source
    ...
    infn2 = "./data_closed_loop/%s.wiki.parsed__operation_type.dat" % source
    ...
    if quadratic:
        infn3 = "./data_closed_loop/%s.wiki.parsed__operation_type_sq.dat" % (source)
