...
@dataclass
class ASyncCycleDataCollection:
...
class ASyncCycle:
    def __init__(
        ...
        experimentalist,
        experiment_runner,
        monitor: Optional[Callable[[ASyncCycleDataCollection], None]] = None,
        params: Optional[Dict] = None,
        data: Optional[Union[Sequence[ResultContainer], ResultContainer]] = None,
    ):
        """
        Args:
        ...
        Aim: Use the ASyncCycle to recover a simple ground truth theory from noisy data.
        ...
        We initialize the ASyncCycle with the metadata describing the domain of the theory,
        ...
        >>> cycle_with_parameters = ASyncCycle(
        ...     metadata=metadata_0,
        ...     theorist=example_theorist,
        ...
        ...     ]
        ... )
        >>> cycle_with_cycle_properties = ASyncCycle(
        ...     metadata=metadata_1,
        ...     theorist=example_theorist,
        ...
        if data is None:
            data = []
        elif isinstance(data, ResultType):
            data = [data]
        elif isinstance(data, Sequence):
            data = list(data)

        self.data: ASyncCycleDataCollection = ASyncCycleDataCollection(
            metadata=metadata,
            data=data,
        )
    ...
    def __next__(self):
        ...
        next_function = self.plan_next_step()
    ...
    def _experimentalist_callback(
        experimentalist: Pipeline, data_in: ASyncCycleDataCollection, params: dict
    ):
    ...
    def _experiment_runner_callback(
        ...
        data_in: ASyncCycleDataCollection,
        params: dict,
    ):
    ...
    @staticmethod
    def _theorist_callback(theorist, data_in: ASyncCycleDataCollection, params: dict):
    ...
    def _monitor_callback(self, data: ASyncCycleDataCollection):
