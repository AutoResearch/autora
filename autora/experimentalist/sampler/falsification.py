...
from autora.experimentalist.pooler.poppernet import PopperNet, \
    class_to_onehot, plot_popper_diagnostics
...
def falsification_sampler(
    ...
    to approximate the loss of a model for all patterns in the training data_closed_loop. Once trained, the
    network is then provided with the candidate samples and the samples with the highest loss are
    selected.
