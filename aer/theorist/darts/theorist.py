...
from aer.variable.variable import outputTypes as output_types
...
from aer.theorist.darts import utils as utils
...
class Theorist_DARTS(Theorist, ABC):
    ...
    def run_meta_search(self, **kwargs):
        super(Theorist_DARTS, self).run_meta_search(**kwargs)
