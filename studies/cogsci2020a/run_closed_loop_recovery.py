...
samples_for_seed = 2           # number of seed data points
samples_per_cycle = 2           # number of data points chosen per cycle
theorist_epochs = 10            # number of epochs for BMS
...
for rep in range(repetitions):
    ...
    X_full, y_full = data
    X_train, X_test, y_train, y_test = train_test_split(X_full, y_full, test_size=.33, random_state=rep)
