...
# training
epochs = 2 #100 # #400 (good) 200                    # num of training epochs (30)
arch_updates_per_epoch = 1 #20      # num of architecture updates per epoch (20)
param_updates_per_epoch = 5 #500   # num of weight updates per epoch (20)
...
n_initializations_sampled = 1 #5 #20            # num of model initializations searched
